...
use eZ\Publish\Core\Pagination\Pagerfanta\LocationSearchHitAdapter as DefaultLocationSearchHitAdapter;
use eZ\Publish\API\Repository\Values\Content\Query;
use eZ\Publish\API\Repository\SearchService;

class LocationSearchHitAdapter extends DefaultLocationSearchHitAdapter
{
    ...
    public function getFacets()
    {
        ...
        return $this->facets = $this->searchService->findLocations($facetQuery)->facets;
    }
